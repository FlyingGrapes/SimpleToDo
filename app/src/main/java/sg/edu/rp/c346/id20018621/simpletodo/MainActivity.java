package sg.edu.rp.c346.id20018621.simpletodo;
...
//                etNewToDo.setText(null);
        ...
        btnClearAll.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (todoNum!=0){
                    ...
                    Toast.makeText(MainActivity.this, "No tasks :D", Toast.LENGTH_SHORT).show();
                }
        ...
        btnDel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (alTodo.size() == 0) {
                    Toast.makeText(MainActivity.this, "No tasks to remove :D", Toast.LENGTH_SHORT).show();
